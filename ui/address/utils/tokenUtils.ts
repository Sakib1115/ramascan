...
const TOKEN_GROUPS_ORDER: Array<TokenType> = [ 'RAMA-20', 'RAMA-721', 'RAMA-1155' ];
...
export const sortingFns = {
  'RAMA-20': sortErc20Tokens,
  'RAMA-721': sortErc721Tokens,
  'RAMA-1155': sortErc1155Tokens,
};
