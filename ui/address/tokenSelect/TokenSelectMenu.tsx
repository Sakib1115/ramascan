    ...
    <>
      ...
      <Flex flexDir="column" rowGap={ 6 }>
        { Object.entries(filteredData).sort(sortTokenGroups).map(([ tokenType, tokenInfo ]) => {
          ...
          const arrowTransform = (type === 'RAMA-1155' && erc1155sort === 'desc') || (type === 'RAMA-20' && erc20sort === 'desc') ?
            'rotate(90deg)' :
            'rotate(-90deg)';
          ...
          const hasSort = type === 'RAMA-1155' || (type === 'RAMA-20' && tokenInfo.items.some(({ usd }) => usd));
