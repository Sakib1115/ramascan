...
export const apps = [
  ...
  },
  {
    ...
    shortDescription: 'Token Approval Tracker shows all approvals for any RAMA20-compliant tokens and NFTs and lets to revoke them or adjust the approved amount.',
    site: 'https://docs.blockscout.com/for-users/blockscout-apps/token-approval-tracker',
    description: 'Token Approval Tracker shows all approvals for any RAMA20-compliant tokens and NFTs and lets to revoke them or adjust the approved amount.',
