...
const DEFAULT_TEMPLATE = 'Ramascan is the #1 open-source blockchain explorer available today. 100+ dapps and counting rely on Ramascan data availability, APIs, and ecosystem tools to support their dapps.';
